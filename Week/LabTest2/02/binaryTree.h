...
public:
    ...
    void printKNode(const elemType& KNode) const;
...
private:
    ...
    void inorderGreatest(nodeType<elemType>* p, const elemType& KNode) const;
...
template <class elemType>
void binaryTreeType<elemType>::printKNode(const elemType& KNode) const
{
    inorderGreatest(root, KNode);
}
...
template <class elemType>
void binaryTreeType<elemType>::inorderGreatest(nodeType<elemType>* p, const elemType& KNode) const
{
    if (p != NULL)
    {
        inorderGreatest(p->lLink, KNode);
        if (p->info > KNode) {
            cout << p->info << " ";
        }
        inorderGreatest(p->rLink, KNode);
    }
}
